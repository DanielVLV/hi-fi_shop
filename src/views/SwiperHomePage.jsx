    ...
    <div className="swiperHomePage glass">
      ...
      <div className="columnRight">
        <p className="textFromHomePage">
          Добро пожаловать в наш интернет-магазин элитной бытовой техники! Мы рады предложить Вам лучшие изделия от ведущих мировых производителей. Наша цель - сделать Вашу жизнь удобнее, комфортнее и престижнее. Ознакомьтесь с нашим ассортиментом и выбирайте лучшее для себя!
        </p>
      </div>
    </div>
  );
